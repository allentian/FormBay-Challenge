...
Based on your requirement, I set up a company list which contains id, name, description, founded, createdAt and updatedAt fields.

I configured the version control/route and implemented token-based authentication, company model and controller.
